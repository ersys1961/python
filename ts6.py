class WareHouseNotValidInput(Exception):
...
class WareHouse:
    ...
    @staticmethod
    def validate_qnt(qnt):
       if type(qnt) == str:
           raise WareHouseNotValidInput('validate_qnt -  количество не число')
...
wh1.inner_move_product(wh2, 123, 'dd')
